...
define linkonce_odr hidden void @_ZN8SourceMM10ISmmPluginD2Ev(%"class.SourceMM::ISmmPlugin"* nocapture %this) unnamed_addr #1 align 2 {
  ret void
}

; Function Attrs: nounwind
define hidden i32 @_Z12HxPlayerDeadv() #2 {
  br label %1
...
; <label>:1                                       ; preds = %76, %0
  ...
  %7 = tail call %"class.SourceMod::IGamePlayer"* %6(%"class.SourceMod::IPlayerManager"* %2, i32 %i.03) #0
...
; <label>:9                                       ; preds = %1
  ...
  %14 = tail call zeroext i1 %13(%"class.SourceMod::IGamePlayer"* %7) #0
...
; <label>:15                                      ; preds = %9
  ...
  %20 = tail call %class.IPlayerInfo* %19(%"class.SourceMod::IGamePlayer"* %7) #0
...
; <label>:22                                      ; preds = %15
  ...
  %27 = tail call i32 %26(%class.IPlayerInfo* %20) #0
  %28 = icmp eq i32 %27, 2
...
; <label>:29                                      ; preds = %22
  ...
  %34 = tail call zeroext i1 %33(%class.IPlayerInfo* %20) #0
...
; <label>:35                                      ; preds = %29
  ...
  %45 = tail call i8* %44(%class.IPlayerInfo* %20) #0
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %40(%"class.SourceMod::ISourceMod"* %36, %"class.SourceMod::IExtension"* %41, i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0), i32 %i.03, i8* %45) #0
  ...
  %49 = tail call zeroext i1 %48(%class.IPlayerInfo* %20) #0
...
; <label>:53                                      ; preds = %50, %35, %29
  ...
  %57 = tail call zeroext i1 %56(%class.IPlayerInfo* %20) #0
...
; <label>:58                                      ; preds = %53
  ...
  %68 = tail call i8* %67(%class.IPlayerInfo* %20) #0
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %63(%"class.SourceMod::ISourceMod"* %59, %"class.SourceMod::IExtension"* %64, i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0), i32 %i.03, i8* %68) #0
  ...
  %72 = tail call zeroext i1 %71(%class.IPlayerInfo* %20) #0
...
; <label>:80                                      ; preds = %78
  ...
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %85(%"class.SourceMod::ISourceMod"* %81, %"class.SourceMod::IExtension"* %86, i8* getelementptr inbounds ([16 x i8]* @.str4, i32 0, i32 0), i32 %iDead1.2) #0
  br label %97
...
; <label>:95                                      ; preds = %87
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %93(%"class.SourceMod::ISourceMod"* %89, %"class.SourceMod::IExtension"* %94, i8* getelementptr inbounds ([16 x i8]* @.str4, i32 0, i32 0), i32 %iDead2.2) #0
  br label %97

; <label>:96                                      ; preds = %87
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %93(%"class.SourceMod::ISourceMod"* %89, %"class.SourceMod::IExtension"* %94, i8* getelementptr inbounds ([16 x i8]* @.str4, i32 0, i32 0), i32 %iDead3.2) #0
  br label %97
...
; Function Attrs: nounwind
define hidden i8* @_Z20GetPlayerByCharacteri(i32 %charaster) #2 {
...
; <label>:6                                       ; preds = %3
  ...
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %11(%"class.SourceMod::ISourceMod"* %7, %"class.SourceMod::IExtension"* %12, i8* getelementptr inbounds ([28 x i8]* @.str5, i32 0, i32 0), i32 %4) #0
  ...
  %18 = tail call %class.CBaseEntity* %17(%"class.SourceMod::IGameHelpers"* %13, i32 %4) #0
...
; <label>:20                                      ; preds = %3
  ...
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %25(%"class.SourceMod::ISourceMod"* %21, %"class.SourceMod::IExtension"* %26, i8* getelementptr inbounds ([13 x i8]* @.str6, i32 0, i32 0)) #0
  br label %30

; <label>:27                                      ; preds = %0
  %28 = load i8* (i32)** @GetPlayerByCharacter_Actual, align 4
  %29 = tail call i8* %28(i32 %charaster) #0
  br label %30
...
; Function Attrs: nounwind
define hidden i8* @_ZN31DefibrillatorOnStartActionClass26DefibrillatorOnStartActionEiPvS0_i(%class.DefibrillatorOnStartActionClass* %this, i32 %reserved, i8* %player, i8* %entity, i32 %reserved2) #2 align 2 {
  ...
  %7 = tail call %struct.edict_t* %5(%class.IServerGameEnts* %1, %class.CBaseEntity* %6) #0
...
; <label>:9                                       ; preds = %0
  ...
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %14(%"class.SourceMod::ISourceMod"* %10, %"class.SourceMod::IExtension"* %15, i8* getelementptr inbounds ([40 x i8]* @.str7, i32 0, i32 0)) #0
...
; <label>:18                                      ; preds = %9
  ...
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %23(%"class.SourceMod::ISourceMod"* %19, %"class.SourceMod::IExtension"* %24, i8* getelementptr inbounds ([28 x i8]* @.str8, i32 0, i32 0)) #0
  ...
  tail call void %29(%class.IVEngineServer* %25, %struct.edict_t* %7) #0
  br label %30
...
; <label>:47                                      ; preds = %45, %38
  ...
  %49 = tail call i8* %48(%class.DefibrillatorOnStartActionClass* %34, i32 %reserved, i8* %player, i8* %entity, i32 %reserved2) #0
  ret i8* %49
}

; Function Attrs: nounwind
define hidden i8* @_ZN34DefibrillatorOnActionCompleteClass29DefibrillatorOnActionCompleteEPvS0_(%class.DefibrillatorOnActionCompleteClass* %this, i8* %player, i8* %entity) #2 align 2 {
  %1 = load %class.IServerGameEnts** @gameents, align 4
  %2 = bitcast %class.IServerGameEnts* %1 to %struct.edict_t* (%class.IServerGameEnts*, %class.CBaseEntity*)***
  %3 = load %struct.edict_t* (%class.IServerGameEnts*, %class.CBaseEntity*)*** %2, align 4
  %4 = getelementptr inbounds %struct.edict_t* (%class.IServerGameEnts*, %class.CBaseEntity*)** %3, i32 4
...
; <label>:9                                       ; preds = %0
  ...
  %14 = load void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)** %13, align 4
  %15 = load %"class.SourceMod::IExtension"** @myself, align 4
  tail call void (%"class.SourceMod::ISourceMod"*, %"class.SourceMod::IExtension"*, i8*, ...)* %14(%"class.SourceMod::ISourceMod"* %10, %"class.SourceMod::IExtension"* %15, i8* getelementptr inbounds ([46 x i8]* @.str9, i32 0, i32 0)) #0
...
; <label>:33                                      ; preds = %31, %24
  ...
  %35 = tail call i8* %34(%class.DefibrillatorOnActionCompleteClass* %20, i8* %player, i8* %entity) #0
  ret i8* %35
}

; Function Attrs: nounwind
define hidden %class.CBaseEntity* @_Z27CSurvivorDeathModel__CreateP11CBasePlayer(%class.CBasePlayer* %bplayer) #2 {
  ...
  %7 = call %struct.edict_t* %5(%class.IServerGameEnts* %1, %class.CBaseEntity* %6) #0
  ...
  %13 = call i32 %12(%"class.SourceMod::IGameHelpers"* %8, %struct.edict_t* %7) #0
  %14 = load %class.CBaseEntity* (%class.CBasePlayer*)** @CSurvivorDeathModel__Create_Actual, align 4
  %15 = call %class.CBaseEntity* %14(%class.CBasePlayer* %bplayer) #0
...
_ZN10CBaseEdict16GetIServerEntityEv.exit.i:       ; preds = %0
  ...
  %23 = call %class.ICollideable* %22(%class.IServerUnknown* %18) #0
  ...
  %28 = call %class.Vector* %27(%class.ICollideable* %23) #0
  ...
  %32 = call i8* %31(%class.CBaseEntity* %15, %class.Vector* %PlayerOrigin) #0
  br label %33
...
; Function Attrs: nounwind
define hidden zeroext i1 @_ZN8DefibFix17SDK_OnMetamodLoadEPN8SourceMM7ISmmAPIEPcjb(%class.DefibFix* nocapture readnone %this, %"class.SourceMM::ISmmAPI"* %ismm, i8* %error, i32 %maxlength, i1 zeroext %late) unnamed_addr #2 align 2 {
  ...
  %8 = tail call i8* (i8*, i32*)* (%"class.SourceMM::ISmmAPI"*, i1)* %7(%"class.SourceMM::ISmmAPI"* %ismm, i1 zeroext true) #0
  %9 = tail call i8* %4(%"class.SourceMM::ISmmAPI"* %ismm, i8* (i8*, i32*)* %8, i8* getelementptr inbounds ([17 x i8]* @.str10, i32 0, i32 0), i32 -1) #0
...
; <label>:15                                      ; preds = %12
  ...
  %20 = tail call i32 (%"class.SourceMM::ISmmAPI"*, i8*, i32, i8*, ...)* %19(%"class.SourceMM::ISmmAPI"* %ismm, i8* %error, i32 %maxlength, i8* getelementptr inbounds ([29 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8]* @.str10, i32 0, i32 0)) #0
  br label %41
...
; <label>:21                                      ; preds = %0
  ...
  %28 = tail call i8* (i8*, i32*)* (%"class.SourceMM::ISmmAPI"*, i1)* %27(%"class.SourceMM::ISmmAPI"* %ismm, i1 zeroext true) #0
  %29 = tail call i8* %24(%"class.SourceMM::ISmmAPI"* %ismm, i8* (i8*, i32*)* %28, i8* getelementptr inbounds ([18 x i8]* @.str12, i32 0, i32 0), i32 0) #0
...
; <label>:35                                      ; preds = %32
  ...
  %40 = tail call i32 (%"class.SourceMM::ISmmAPI"*, i8*, i32, i8*, ...)* %39(%"class.SourceMM::ISmmAPI"* %ismm, i8* %error, i32 %maxlength, i8* getelementptr inbounds ([29 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8]* @.str12, i32 0, i32 0)) #0
  br label %41
...
; Function Attrs: nounwind
define hidden zeroext i1 @_ZN8DefibFix10SDK_OnLoadEPcjb(%class.DefibFix* nocapture readnone %this, i8* nocapture %error, i32 %maxlength, i1 zeroext %late) unnamed_addr #2 align 2 {
  %conf_error = alloca [255 x i8], align 1
  store i32 0, i32* @ig_defib, align 4
  store i32 0, i32* @ig_noob, align 4
  %1 = getelementptr inbounds [255 x i8]* %conf_error, i32 0, i32 0
  call void @llvm.lifetime.start(i64 255, i8* %1) #0
  %2 = load %"class.SourceMod::IGameConfigManager"** @gameconfs, align 4
  %3 = bitcast %"class.SourceMod::IGameConfigManager"* %2 to i1 (%"class.SourceMod::IGameConfigManager"*, i8*, %"class.SourceMod::IGameConfig"**, i8*, i32)***
  %4 = load i1 (%"class.SourceMod::IGameConfigManager"*, i8*, %"class.SourceMod::IGameConfig"**, i8*, i32)*** %3, align 4
  %5 = getelementptr inbounds i1 (%"class.SourceMod::IGameConfigManager"*, i8*, %"class.SourceMod::IGameConfig"**, i8*, i32)** %4, i32 3
  %6 = load i1 (%"class.SourceMod::IGameConfigManager"*, i8*, %"class.SourceMod::IGameConfig"**, i8*, i32)** %5, align 4
  %7 = call zeroext i1 %6(%"class.SourceMod::IGameConfigManager"* %2, i8* getelementptr inbounds ([9 x i8]* @.str13, i32 0, i32 0), %"class.SourceMod::IGameConfig"** @g_pGameConf, i8* %1, i32 255) #0
  br i1 %7, label %10, label %8

; <label>:8                                       ; preds = %0
  %9 = call i32 (i8*, i32, i8*, ...)* @snprintf(i8* %error, i32 %maxlength, i8* getelementptr inbounds ([32 x i8]* @.str14, i32 0, i32 0), i8* %1) #0
  br label %14
...
; <label>:12                                      ; preds = %10
  %13 = call i32 (i8*, i32, i8*, ...)* @snprintf(i8* %error, i32 %maxlength, i8* getelementptr inbounds ([32 x i8]* @.str15, i32 0, i32 0)) #0
  br label %14

; <label>:14                                      ; preds = %10, %12, %8
  %.0 = phi i1 [ false, %12 ], [ false, %8 ], [ true, %10 ]
  call void @llvm.lifetime.end(i64 255, i8* %1) #0
  ret i1 %.0
}
...
; Function Attrs: nounwind
define hidden zeroext i1 @_ZN8DefibFix10SetupHooksEv(%class.DefibFix* nocapture readnone %this) #2 align 2 {
  ...
  %6 = tail call %"class.SourcePawn::ISourcePawnEngine"* %5(%"class.SourceMod::ISourceMod"* %1) #0
  %7 = load %"class.SourceMod::IGameConfig"** @g_pGameConf, align 4
  tail call void @_ZN14CDetourManager4InitEPN10SourcePawn17ISourcePawnEngineEPN9SourceMod11IGameConfigE(%"class.SourcePawn::ISourcePawnEngine"* %6, %"class.SourceMod::IGameConfig"* %7) #0
  ...
  %13 = tail call zeroext i1 %12(%"class.SourceMod::IGameConfig"* %8, i8* getelementptr inbounds ([26 x i8]* @.str16, i32 0, i32 0), i8** bitcast (i8* (%class.CBaseEntity*, %class.Vector*)** @CBaseEntity__SetAbsOrigin to i8**)) #0
  %14 = tail call %class.CDetour* @_ZN14CDetourManager12CreateDetourEPvPS0_PKc(i8* bitcast (i8* (i32)* @_Z20GetPlayerByCharacteri to i8*), i8** bitcast (i8* (i32)** @GetPlayerByCharacter_Actual to i8**), i8* getelementptr inbounds ([21 x i8]* @.str17, i32 0, i32 0)) #0
...
; <label>:27                                      ; preds = %0
  tail call void @_ZN7CDetour12EnableDetourEv(%class.CDetour* %18) #0
  %28 = load %class.CDetour** @hg_defibStart, align 4
  tail call void @_ZN7CDetour12EnableDetourEv(%class.CDetour* %28) #0
  %29 = load %class.CDetour** @hg_defibEnd, align 4
  tail call void @_ZN7CDetour12EnableDetourEv(%class.CDetour* %29) #0
  %30 = load %class.CDetour** @hg_deadPlayer, align 4
  tail call void @_ZN7CDetour12EnableDetourEv(%class.CDetour* %30) #0
...
; <label>:33                                      ; preds = %31
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %18) #0
...
; <label>:37                                      ; preds = %34
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %35) #0
...
; <label>:41                                      ; preds = %38
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %39) #0
...
; <label>:45                                      ; preds = %42
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %43) #0
...
; Function Attrs: nounwind
define hidden void @_ZN8DefibFix12SDK_OnUnloadEv(%class.DefibFix* nocapture readnone %this) unnamed_addr #2 align 2 {
  %1 = load %class.CDetour** @hg_getPlayer, align 4
  %2 = icmp eq %class.CDetour* %1, null
  br i1 %2, label %4, label %3

; <label>:3                                       ; preds = %0
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %1) #0
  store %class.CDetour* null, %class.CDetour** @hg_getPlayer, align 4
  br label %4
...
; <label>:7                                       ; preds = %4
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %5) #0
  store %class.CDetour* null, %class.CDetour** @hg_defibStart, align 4
  br label %8
...
; <label>:11                                      ; preds = %8
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %9) #0
  store %class.CDetour* null, %class.CDetour** @hg_defibEnd, align 4
  br label %12
...
; <label>:15                                      ; preds = %12
  tail call void @_ZN7CDetour7DestroyEv(%class.CDetour* %13) #0
  store %class.CDetour* null, %class.CDetour** @hg_deadPlayer, align 4
  br label %_ZN8DefibFix11RemoveHooksEv.exit
...
_ZN8DefibFix11RemoveHooksEv.exit:                 ; preds = %12, %15
  ...
  tail call void %20(%"class.SourceMod::IGameConfigManager"* %16, %"class.SourceMod::IGameConfig"* %21) #0
  ret void
}

; Function Attrs: nounwind
define hidden void @_ZN8DefibFix11RemoveHooksEv(%class.DefibFix* nocapture readnone %this) #2 align 2 {
  %1 = load %class.CDetour** @hg_getPlayer, align 4
  %2 = icmp eq %class.CDetour* %1, null
  br i1 %2, label %4, label %3
...
; Function Attrs: nounwind readnone
define linkonce_odr hidden i32 @_ZN8SourceMM10ISmmPlugin13GetApiVersionEv(%"class.SourceMM::ISmmPlugin"* nocapture readnone %this) unnamed_addr #1 align 2 {
  ret i32 15
}

; Function Attrs: inlinehint nounwind
define linkonce_odr hidden void @_ZN8DefibFixD0Ev(%class.DefibFix* %this) unnamed_addr #4 align 2 {
...
; Function Attrs: nounwind readnone
define linkonce_odr hidden void @_ZN8SourceMM10ISmmPlugin16AllPluginsLoadedEv(%"class.SourceMM::ISmmPlugin"* nocapture %this) unnamed_addr #1 align 2 {
  ret void
}

; Function Attrs: nounwind readnone
define linkonce_odr hidden zeroext i1 @_ZN8SourceMM10ISmmPlugin12QueryRunningEPcj(%"class.SourceMM::ISmmPlugin"* nocapture readnone %this, i8* nocapture readnone %error, i32 %maxlen) unnamed_addr #1 align 2 {
  ret i1 true
}
...
; Function Attrs: nounwind readnone
define linkonce_odr hidden i32 @_ZN9SourceMod19IExtensionInterface19GetExtensionVersionEv(%"class.SourceMod::IExtensionInterface"* nocapture readnone %this) unnamed_addr #1 align 2 {
  ret i32 8
}

; Function Attrs: nounwind
define available_externally hidden zeroext i1 @_ZThn4_N12SDKExtension15OnExtensionLoadEPN9SourceMod10IExtensionEPNS0_9IShareSysEPcjb(%class.SDKExtension* %this, %"class.SourceMod::IExtension"* %me, %"class.SourceMod::IShareSys"* %sys, i8* %error, i32 %maxlength, i1 zeroext %late) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call zeroext i1 @_ZN12SDKExtension15OnExtensionLoadEPN9SourceMod10IExtensionEPNS0_9IShareSysEPcjb(%class.SDKExtension* %2, %"class.SourceMod::IExtension"* %me, %"class.SourceMod::IShareSys"* %sys, i8* %error, i32 %maxlength, i1 zeroext %late) #0
  ret i1 %3
}

; Function Attrs: nounwind
define available_externally hidden void @_ZThn4_N12SDKExtension17OnExtensionUnloadEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  tail call void @_ZN12SDKExtension17OnExtensionUnloadEv(%class.SDKExtension* %2) #0
  ret void
}

; Function Attrs: nounwind
define available_externally hidden void @_ZThn4_N12SDKExtension21OnExtensionsAllLoadedEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  tail call void @_ZN12SDKExtension21OnExtensionsAllLoadedEv(%class.SDKExtension* %2) #0
  ret void
}

; Function Attrs: nounwind
define available_externally hidden void @_ZThn4_N12SDKExtension22OnExtensionPauseChangeEb(%class.SDKExtension* %this, i1 zeroext %state) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  tail call void @_ZN12SDKExtension22OnExtensionPauseChangeEb(%class.SDKExtension* %2, i1 zeroext %state) #0
  ret void
}

; Function Attrs: nounwind readnone
define linkonce_odr hidden zeroext i1 @_ZN9SourceMod19IExtensionInterface18QueryInterfaceDropEPNS_11SMInterfaceE(%"class.SourceMod::IExtensionInterface"* nocapture readnone %this, %"class.SourceMod::SMInterface"* nocapture readnone %pInterface) unnamed_addr #1 align 2 {
  ret i1 false
}

; Function Attrs: nounwind readnone
define linkonce_odr hidden void @_ZN9SourceMod19IExtensionInterface19NotifyInterfaceDropEPNS_11SMInterfaceE(%"class.SourceMod::IExtensionInterface"* nocapture %this, %"class.SourceMod::SMInterface"* nocapture %pInterface) unnamed_addr #1 align 2 {
  ret void
}

; Function Attrs: nounwind readnone
define linkonce_odr hidden zeroext i1 @_ZN9SourceMod19IExtensionInterface12QueryRunningEPcj(%"class.SourceMod::IExtensionInterface"* nocapture readnone %this, i8* nocapture readnone %error, i32 %maxlength) unnamed_addr #1 align 2 {
  ret i1 true
}

; Function Attrs: nounwind
define available_externally hidden zeroext i1 @_ZThn4_N12SDKExtension18IsMetamodExtensionEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call zeroext i1 @_ZN12SDKExtension18IsMetamodExtensionEv(%class.SDKExtension* %2) #0
  ret i1 %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension16GetExtensionNameEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension16GetExtensionNameEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension15GetExtensionURLEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension15GetExtensionURLEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension15GetExtensionTagEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension15GetExtensionTagEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension18GetExtensionAuthorEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension18GetExtensionAuthorEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension21GetExtensionVerStringEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension21GetExtensionVerStringEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension23GetExtensionDescriptionEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension23GetExtensionDescriptionEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind
define available_externally hidden i8* @_ZThn4_N12SDKExtension22GetExtensionDateStringEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  %3 = tail call i8* @_ZN12SDKExtension22GetExtensionDateStringEv(%class.SDKExtension* %2) #0
  ret i8* %3
}

; Function Attrs: nounwind readnone
define linkonce_odr hidden void @_ZN9SourceMod19IExtensionInterface14OnCoreMapStartEP7edict_tii(%"class.SourceMod::IExtensionInterface"* nocapture %this, %struct.edict_t* nocapture %pEdictList, i32 %edictCount, i32 %clientMax) unnamed_addr #1 align 2 {
  ret void
}

; Function Attrs: nounwind
define available_externally hidden void @_ZThn4_N12SDKExtension21OnDependenciesDroppedEv(%class.SDKExtension* %this) unnamed_addr #2 align 2 {
  %1 = getelementptr inbounds %class.SDKExtension* %this, i32 -1, i32 2
  %2 = bitcast i8* %1 to %class.SDKExtension*
  tail call void @_ZN12SDKExtension21OnDependenciesDroppedEv(%class.SDKExtension* %2) #0
  ret void
}

; Function Attrs: nounwind readnone
define linkonce_odr hidden void @_ZN9SourceMod19IExtensionInterface12OnCoreMapEndEv(%"class.SourceMod::IExtensionInterface"* nocapture %this) unnamed_addr #1 align 2 {
  ret void
}
...
define internal void @_GLOBAL__I_a() #0 section ".text.startup" {
  ...
  %1 = tail call {}* @llvm.invariant.start(i64 4, i8* getelementptr inbounds (%class.Color* @_ZL25UNSPECIFIED_LOGGING_COLOR, i32 0, i32 0, i32 0)) #0
  ...
  %2 = tail call {}* @llvm.invariant.start(i64 8, i8* bitcast (%class.Vector2D* @_ZL11vec2_origin to i8*)) #0
  ...
  %3 = tail call {}* @llvm.invariant.start(i64 8, i8* bitcast (%class.Vector2D* @_ZL12vec2_invalid to i8*)) #0
  tail call void @_ZN12SDKExtensionC2Ev(%class.SDKExtension* getelementptr inbounds (%class.DefibFix* @g_DefibFix, i32 0, i32 0)) #0
