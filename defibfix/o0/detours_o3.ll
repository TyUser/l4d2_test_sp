...
; <label>:5                                       ; preds = %0
  %6 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 3
  %7 = load i8** %6, align 4
  %8 = ptrtoint i8* %7 to i32
  %9 = and i32 %8, -4096
  %10 = inttoptr i32 %9 to i8*
  %11 = tail call i32 @sysconf(i32 30) #6
  %12 = tail call i32 @mprotect(i8* %10, i32 %11, i32 7) #6
  %.pre.i.i.i = getelementptr inbounds %class.CDetour* %this, i32 0, i32 2, i32 1
  %13 = load i32* %.pre.i.i.i, align 4
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %_ZN7CDetour13DisableDetourEv.exit.i, label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %5, %.lr.ph.i.i.i
  %i1.02.i.i.i = phi i32 [ %18, %.lr.ph.i.i.i ], [ 0, %5 ]
  %15 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 2, i32 0, i32 %i1.02.i.i.i
  %16 = load i8* %15, align 1
  %17 = getelementptr inbounds i8* %7, i32 %i1.02.i.i.i
  store i8 %16, i8* %17, align 1
  %18 = add i32 %i1.02.i.i.i, 1
  %19 = load i32* %.pre.i.i.i, align 4
  %20 = icmp ult i32 %18, %19
  br i1 %20, label %.lr.ph.i.i.i, label %_ZN7CDetour13DisableDetourEv.exit.i

_ZN7CDetour13DisableDetourEv.exit.i:              ; preds = %.lr.ph.i.i.i, %5
  store i8 0, i8* %1, align 1
  br label %21

; <label>:21                                      ; preds = %_ZN7CDetour13DisableDetourEv.exit.i, %0
  %22 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 4
  %23 = load i8** %22, align 4
  %24 = icmp eq i8* %23, null
  br i1 %24, label %_ZN7CDetour12DeleteDetourEv.exit, label %_ZN7CDetour12DeleteDetourEv.exit.thread

_ZN7CDetour12DeleteDetourEv.exit.thread:          ; preds = %21
  ...
  tail call void %30(%"class.SourcePawn::ISourcePawnEngine"* %26, i8* %23) #6
  br label %32

_ZN7CDetour12DeleteDetourEv.exit:                 ; preds = %21
  %31 = icmp eq %class.CDetour* %this, null
  br i1 %31, label %34, label %32

; <label>:32                                      ; preds = %_ZN7CDetour12DeleteDetourEv.exit.thread, %_ZN7CDetour12DeleteDetourEv.exit
  %33 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 0
  tail call void @_ZdlPv(i8* %33) #5
  br label %34

; <label>:34                                      ; preds = %32, %_ZN7CDetour12DeleteDetourEv.exit
  ret void
}
...
; <label>:5                                       ; preds = %0
  ...
  %13 = load i32* %.pre.i.i, align 4
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %_ZN7CDetour13DisableDetourEv.exit, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %5, %.lr.ph.i.i
  %i1.02.i.i = phi i32 [ %18, %.lr.ph.i.i ], [ 0, %5 ]
  %15 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 2, i32 0, i32 %i1.02.i.i
  %16 = load i8* %15, align 1
  %17 = getelementptr inbounds i8* %7, i32 %i1.02.i.i
  store i8 %16, i8* %17, align 1
  %18 = add i32 %i1.02.i.i, 1
  %19 = load i32* %.pre.i.i, align 4
  %20 = icmp ult i32 %18, %19
  br i1 %20, label %.lr.ph.i.i, label %_ZN7CDetour13DisableDetourEv.exit

_ZN7CDetour13DisableDetourEv.exit:                ; preds = %.lr.ph.i.i, %5
  store i8 0, i8* %1, align 1
  br label %21

; <label>:21                                      ; preds = %0, %_ZN7CDetour13DisableDetourEv.exit
  %22 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 4
  %23 = load i8** %22, align 4
  %24 = icmp eq i8* %23, null
...
; <label>:25                                      ; preds = %21
  %26 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 8
  %27 = load %"class.SourcePawn::ISourcePawnEngine"** %26, align 4
  %28 = bitcast %"class.SourcePawn::ISourcePawnEngine"* %27 to void (%"class.SourcePawn::ISourcePawnEngine"*, i8*)***
  %29 = load void (%"class.SourcePawn::ISourcePawnEngine"*, i8*)*** %28, align 4
  %30 = getelementptr inbounds void (%"class.SourcePawn::ISourcePawnEngine"*, i8*)** %29, i32 13
  %31 = load void (%"class.SourcePawn::ISourcePawnEngine"*, i8*)** %30, align 4
  tail call void %31(%"class.SourcePawn::ISourcePawnEngine"* %27, i8* %23) #6
...
; <label>:5                                       ; preds = %0
  ...
  %13 = load i32* %.pre.i, align 4
  %14 = icmp eq i32 %13, 0
  br i1 %14, label %_Z10ApplyPatchPviPK7patch_tPS0_.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %5, %.lr.ph.i
  %i1.02.i = phi i32 [ %18, %.lr.ph.i ], [ 0, %5 ]
  %15 = getelementptr inbounds %class.CDetour* %this, i32 0, i32 2, i32 0, i32 %i1.02.i
  %16 = load i8* %15, align 1
  %17 = getelementptr inbounds i8* %7, i32 %i1.02.i
  store i8 %16, i8* %17, align 1
  %18 = add i32 %i1.02.i, 1
  %19 = load i32* %.pre.i, align 4
  %20 = icmp ult i32 %18, %19
  br i1 %20, label %.lr.ph.i, label %_Z10ApplyPatchPviPK7patch_tPS0_.exit

_Z10ApplyPatchPviPK7patch_tPS0_.exit:             ; preds = %.lr.ph.i, %5
  store i8 0, i8* %1, align 1
  br label %21

; <label>:21                                      ; preds = %0, %_Z10ApplyPatchPviPK7patch_tPS0_.exit
  ret void
}
...
; <label>:5                                       ; preds = %0
  ...
  %13 = tail call i32 @sysconf(i32 30) #6
  %14 = tail call i32 @mprotect(i8* %12, i32 %13, i32 7) #6
  store i8 -1, i8* %7, align 1
  %15 = getelementptr inbounds i8* %7, i32 1
  store i8 37, i8* %15, align 1
  %16 = getelementptr inbounds i8* %7, i32 2
